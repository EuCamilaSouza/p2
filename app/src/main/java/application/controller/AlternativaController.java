...
import application.AlternativaRepository;

@Controller
@RequestMapping("/alternativa")
public class AlternativaController {
     @Autowired
     private AlternativaRepository alternativaRepository alternativaRepo;

    @RequestMapping("/list")
    public String list(Model model) {
        model.addAttribute("alternativas", alternativaRepo.findAll());
